...
public class ResourcesTest extends TestCase {
    ...
    public void testGetResourcesByMediaType2() {
        ...
        assertEquals(3, resources
                .getResourcesByMediaTypes(new MediaType[]{MediatypeService.XHTML, MediatypeService.PNG}).size());
        assertEquals(3, resources.getResourcesByMediaTypes(new MediaType[]{MediatypeService.CSS, MediatypeService.XHTML,
                                                                           MediatypeService.PNG}).size());
    }
}
