...
public class PackageDocumentBase {
    static final String BOOK_ID_ID = "BookId";
    static final String NAMESPACE_OPF = "http://www.idpf.org/2007/opf";
    static final String NAMESPACE_DUBLIN_CORE = "http://purl.org/dc/elements/1.1/";
    static final String PREFIX_DUBLIN_CORE = "dc";
    static final String PREFIX_OPF = "opf";
